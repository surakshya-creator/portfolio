        ...
        <div className="md:col-span-1">
          <div className="sticky top-24 space-y-4">
            ...
            <Link
              href="/resume.pdf"
              target="_blank"
              className="inline-flex w-full items-center ustify-centerj rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2"
            >
